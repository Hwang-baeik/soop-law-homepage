    ...
    <header className="sticky top-0 z-[60] border-b border-stone-200 bg-white/95 backdrop-blur">
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-5 px-4 py-3 sm:px-6">
        ...
        <nav className="hidden items-center gap-6 text-sm font-semibold text-stone-600 lg:flex">
          ...
          <Link href="/mypage" className="hover:text-emerald-900">내 회사</Link>
        </nav>

        <div className="flex items-center gap-2">
          <Link href="/signup" className="hidden rounded-full px-3 py-2 text-sm font-semibold text-stone-600 hover:bg-stone-100 sm:inline-flex">회원가입</Link>
          ...
          <Link href="/mypage" className="hidden rounded-full bg-emerald-900 px-4 py-2 text-sm font-bold text-white hover:bg-emerald-950 md:inline-flex">내 회사</Link>
        </div>
      </div>
      ...
      <div className="flex gap-1 overflow-x-auto border-t border-stone-100 px-4 py-2 text-sm font-semibold text-stone-600 lg:hidden">
        ...
        <Link href="/mypage" className="whitespace-nowrap rounded-full px-3 py-1.5 hover:bg-stone-100">내 회사</Link>
        <Link href="/signup" className="whitespace-nowrap rounded-full px-3 py-1.5 hover:bg-stone-100 sm:hidden">회원가입</Link>
      </div>
    </header>
  );
}
